...
public class Adminmail extends JFrame {
	...
	public Adminmail() {
		...
		lblNewLabel_1.setBounds(58, 82, 191, 40);
		contentPane.add(lblNewLabel_1);
		
		textField = new JTextField();
		textField.setFont(new Font("Tahoma", Font.BOLD, 22));
		textField.setColumns(10);
		textField.setBounds(255, 82, 388, 40);
		...
		btnNewButton_1.setBounds(320, 303, 205, 68);
		...
		lblNewLabel.setBounds(282, 236, 342, 49);
